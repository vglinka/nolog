...
trace { ( $($a:tt)* ) => { logonly_helper!(trace_inner!($($a)*)); } }

#[macro_export]
#[cfg(feature = "debug")] macro_rules!
debug { ( $($a:tt)* ) => { logonly_helper!(debug_inner!($($a)*)); } }

#[macro_export]
#[cfg(feature = "info")] macro_rules!
info { ( $($a:tt)* )  => { logonly_helper!(info_inner!($($a)*)); } }

#[macro_export]
#[cfg(feature = "warn")] macro_rules!
warn { ( $($a:tt)* )  => { logonly_helper!(warn_inner!($($a)*)); } }

#[macro_export]
#[cfg(feature = "error")] macro_rules!
error { ( $($a:tt)* ) => { logonly_helper!(error_inner!($($a)*)); } }

#[macro_export]
#[cfg(feature = "crit")] macro_rules!
crit { ( $($a:tt)* )  => { logonly_helper!(crit_inner!($($a)*)); } }
